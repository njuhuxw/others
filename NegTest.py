...
vcocopkl=open('Trainval_Neg_VCOCO_with_pose.pkl','rb')
...
print ("@@#$write")
with open('Trainval_Neg3_VCOCO_with_pose.pkl', 'wb+') as f:
    pickle.dump(final_result, f)
f.close()

output2 = open('Trainval_Neg3_VCOCO_with_pose.pkl', 'rb')
